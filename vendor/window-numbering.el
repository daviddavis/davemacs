...
(defvar window-numbering-keymap
  (let ((map (make-sparse-keymap)))
    ;; (define-key map "\s-0" 'select-window-0)
    ;; (define-key map "\s-1" 'select-window-1)
    ;; (define-key map "\s-2" 'select-window-2)
    ;; (define-key map "\s-3" 'select-window-3)
    ;; (define-key map "\s-4" 'select-window-4)
    ;; (define-key map "\s-5" 'select-window-5)
    ;; (define-key map "\s-6" 'select-window-6)
    ;; (define-key map "\s-7" 'select-window-7)
    ;; (define-key map "\s-8" 'select-window-8)
    ;; (define-key map "\s-9" 'select-window-9)
    map)
